...
function ca(e, t) {
    ...
    function a(s, l) {
        var c, u, d = He(s)[b],
            v = new Oe(l, (c = (u = n.options_) == null ? void 0 : u.enhancer) != null ? c : Ne, process.env.NODE_ENV !== "production" ? d.name_ + "." + i.toString() : "ObservableObject." + i.toString(), !1);
...
var Na = {
    ...
    }, N = /* @__PURE__ */ Jr(ci, Na), ui = "computed", xa = "computed.struct", Sn = /* @__PURE__ */ Mn(ui),
    _a = /* @__PURE__ */ Mn(xa, {
...
var Un = "action", qa = "action.bound", Ei = "autoAction", Ga = "autoAction.bound", Oi = "<unnamed action>",
    _n = /* @__PURE__ */ At(Un), Ka = /* @__PURE__ */ At(qa, {
        bound: !0
    }), Pn = /* @__PURE__ */ At(Ei, {
        autoAction: !0
    }), Ha = /* @__PURE__ */ At(Ga, {
...
function Ni(e, t) {
    ...
    var a = (n = (r = t) == null ? void 0 : r.name) != null ? n : process.env.NODE_ENV !== "production" ? e.name || "Autorun@" + W() : "Autorun",
...
function _i(e, t, n) {
    ...
    var a = (r = n.name) != null ? r : process.env.NODE_ENV !== "production" ? "Reaction@" + W() : "Reaction",
        s = Ae(a, n.onError ? Ya(n.onError, t) : t), l = !n.scheduler && !n.delay, c = xi(n), u = !0, d = !1, v,
...
var vn = /* @__PURE__ */ ii("flow"), is = /* @__PURE__ */ ii("flow.bound", {
    ...
    var r = t, i = r.name || "<unnamed flow>", o = function () {
        var s = this, l = arguments, c = ++rs, u = Ae(i + " - runid: " + c + " - init", r).apply(s, l), d, v = void 0,
            g = new Promise(function (m, A) {
                var x = 0;
                d = A;
...
var vs = {}, ce = "add", Zt = "delete", Ii = /* @__PURE__ */ function () {
    ...
    return t.has_ = function (r) {
        ...
        X(this.keysAtom_), re(function () {
            var c,
                u = new Oe(i, o.enhancer_, process.env.NODE_ENV !== "production" ? o.name_ + "." + An(r) : "ObservableMap.key", !1);
...
Extending builtins is not supported.`), e;
    ...
    var r = (n = t?.name) != null ? n : process.env.NODE_ENV !== "production" ? (C(e) ? "ObservableObject" : e.constructor.name) + "@" + W() : "ObservableObject",
...
const Ns = Symbol.for("react.portal"), xs = Symbol.for("react.fragment"), _s = Symbol.for("react.strict_mode"),
    Ps = Symbol.for("react.profiler"), Cs = Symbol.for("react.provider"), Ds = Symbol.for("react.context"),
    zi = Symbol.for("react.forward_ref"), Rs = Symbol.for("react.suspense"), Ts = Symbol.for("react.suspense_list"),
    Vs = Symbol.for("react.memo"), Is = Symbol.for("react.lazy");
...
const Zn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), Ce = "copilot-", Ks = "24.6.0",
    Uc = "attention-required", Bc = "https://plugins.jetbrains.com/plugin/23758-vaadin",
 ...
 */
const It = globalThis,
    Gn = It.ShadowRoot && (It.ShadyCSS === void 0 || It.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype,
    Kn = Symbol(), Sr = /* @__PURE__ */ new WeakMap();
let Xi = class {
    constructor(t, n, r) {
...
const {
        ...
        getPrototypeOf: bl
    } = Object, cn = globalThis, xr = cn.trustedTypes, ml = xr ? xr.emptyScript : "",
    yl = cn.reactiveElementPolyfillSupport, lt = (e, t) => e, Rn = {
        toAttribute(e, t) {
            switch (t) {
                case Boolean:
                    e = e ? ml : null;
    ...
    _$AK(t, n) {
        ...
        if (i !== void 0 && this._$Em !== i) {
            const o = r.getPropertyOptions(i),
                a = typeof o.converter == "function" ? {fromAttribute: o.converter} : o.converter?.fromAttribute !== void 0 ? o.converter : Rn;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Hn = globalThis, Jt = Hn.trustedTypes, Cr = Jt ? Jt.createPolicy("lit-html", {createHTML: (e) => e}) : void 0,
    Jn = "$lit$", ie = `lit$${Math.random().toFixed(9).slice(2)}$`, Xn = "?" + ie, El = `<${Xn}>`, De = document,
    gt = () => De.createComment(""), bt = (e) => e === null || typeof e != "object" && typeof e != "function",
    Yn = Array.isArray, Qi = (e) => Yn(e) || typeof e?.[Symbol.iterator] == "function", bn = `[ 	
\f\r]`, tt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Dr = /-->/g, Rr = />/g, me = RegExp(`>|${bn}(?:([^\\s"'>=/]+)(${bn}*=${bn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Tr = /'/g, Vr = /"/g, $i = /^(?:script|style|textarea|title)$/i,
    eo = (e) => (t, ...n) => ({_$litType$: e, strings: t, values: n}), ct = eo(1), Xc = eo(2),
    he = Symbol.for("lit-noChange"), O = Symbol.for("lit-nothing"), Ir = /* @__PURE__ */ new WeakMap(),
    Ee = De.createTreeWalker(De, 129);
...
const Ol = {M: Jn, P: ie, A: Xn, C: 1, L: no, R: ro, D: Qi, V: Re, I: Ye, H: St, N: oo, U: ao, B: io, F: so},
    Sl = Hn.litHtmlPolyfillSupport;
...
const wo = () => {
    ...
    }, Kl = async () => Zn(`${Ce}get-user-info`, {}, (e) => (delete e.data.reqId, e.data)),
    Hl = async () => Zi(() => p.userInfo), ru = async () => (await Hl()).vaadiner;
